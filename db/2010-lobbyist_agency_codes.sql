DROP TABLE public.lobbyist_agency_codes;
CREATE TABLE public.lobbyist_agency_codes (
  code          varchar(10)  NOT NULL,
  name          varchar(150) NOT NULL,
  parent        varchar(150) NULL,

  CONSTRAINT lobbyist_agency_codes_pk PRIMARY KEY(code)
);

INSERT INTO public.lobbyist_agency_codes(code, name, parent)
